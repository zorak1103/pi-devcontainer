...
REQUIRED="README.md LICENSE docs/architecture.md docs/decisions.md docs/findings.md docs/setup-windows.md docs/how-to.md docs/extending.md docs/comparison.md docs/providers.md docs/threat-model.md"
